...
url:string;
  constructor(
    ...
    this.url=environment.baseUrl+"Items";
  }
  ...
  getCollaborationContent() {
    return this.http.get(`${environment.baseUrl}collaborationDatas`);
  }

  addNewCollabration(addUser) {
    return this.http.post(`${environment.baseUrl}collaborationDatas`, addUser);
  }
