...
export class ProductsComponent implements OnInit {
	...
	displayedProductColumns: string[] = ['id', 'image', 'name', 'brand', 'category', 'productCode', 'discountPrice', 'price', 'action'];
	...
	ngOnInit() {
		this.adminPanelService.getProducts().subscribe(res => this.getProductResponse(res));
	}
